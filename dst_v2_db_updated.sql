...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 29 juin 2020 à 10:47
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_capex` (IN `capex_name` VARCHAR(255), IN `capex_desc` VARCHAR(255), IN `idUC` INT, IN `idProj` INT)  BEGIN
                                DECLARE itemID INT;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_implem` (IN `implem_name` VARCHAR(255), IN `implem_desc` VARCHAR(255), IN `idUC` INT, IN `idProj` INT)  BEGIN
                                DECLARE itemID INT;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_opex` (IN `opex_name` VARCHAR(255), IN `opex_desc` VARCHAR(255), IN `idUC` INT, IN `idProj` INT)  BEGIN
                                DECLARE itemID INT;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_user` (IN `username` VARCHAR(255), IN `salt` VARCHAR(255), IN `password` VARCHAR(255), IN `nameMeasure` VARCHAR(255), IN `description` VARCHAR(255), IN `is_admin` INT)  BEGIN
                                DECLARE userID INT;
...
CREATE TABLE IF NOT EXISTS `crit` (
  ...
  `name` varchar(255) NOT NULL,
  `description` text DEFAULT NULL,
  `scoring_guidance` text DEFAULT NULL,
...
(2, 3, '2020-01-01', '2020-02-01', '2020-03-01', '2020-04-01', '2020-05-01'),
(1, 3, '2020-01-01', '2020-02-01', '2020-03-01', '2020-04-01', '2020-05-01'),
...
(2, 3, '2020-02-01', '2020-03-01', '2020-04-01', '2020-05-01', '2020-06-01', '2020-07-01'),
(1, 3, '2020-02-01', '2020-03-01', '2020-04-01', '2020-05-01', '2020-06-01', '2020-07-01'),
...
(4, 'test', '28 02', 3.5, NULL, NULL, '2020-02-28 13:06:40', '2020-06-17 12:39:53', 1, 1, 0),
...
INSERT INTO `use_cases_menu` (`id`, `name`, `description`, `creation_date`, `modif_date`, `id_user`) VALUES
(1, 'projet', '', '2020-02-11 14:55:56', '2020-05-14 16:34:23', 1),
(4, 'projet2', '', '2020-04-17 11:09:45', '2020-05-18 09:57:59', 1),
(3, 'uc_eval', '', '2020-02-13 12:22:10', '2020-02-13 12:22:20', 2);
