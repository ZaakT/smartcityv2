...
function supplier_schedule($twig,$is_connected, $projID){
    ...
    echo $twig->render('/input/supplier_schedule.twig',array('is_connected'=>$is_connected,'devises'=>$devises,'selDevSym'=>$selDevSym,'selDevName'=>$selDevName,'is_admin'=>$user[3], 'projID'=>$projID));
    prereq_ipc(0);
}
