...
function modify_infos($twig,$is_connected,$isTaken=false){
    ...
    echo $twig->render('/others/profile_menu/modify_infos.twig',array('is_connected'=>$is_connected,'devises'=>$devises,'selDevSym'=>$selDevSym,'selDevName'=>$selDevName,'is_admin'=>$user[3],'username'=>$user[1],'isTaken'=>$isTaken)); 
}
